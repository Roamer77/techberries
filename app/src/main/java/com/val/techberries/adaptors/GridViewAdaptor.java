...
public class GridViewAdaptor extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        TextView cost = view.findViewById(R.id.GridView_productCost);

        ImageButton likeBtn = view.findViewById(R.id.prodctListGridView_likeBtn);
        ImageButton addToCartBtn = view.findViewById(R.id.prodctListGridView_addToCartBtn);
